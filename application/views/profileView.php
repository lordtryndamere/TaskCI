...
<div class="contaier p-4">
    ...
    <div class="row">
        ...
        <?php 
            ...
            <div class="col-md-8">
                <table class="table  table-dark table-bordered table-hover display" id="table_id" > 
                        ...
                        foreach ($results as $row) {  ?>
                            <tr>
                               <td><?=  $row->title ?></td>
                                ...
                                <td><?=  $row->create_at ?></td>
                                <td>
                                <a href="<?php echo base_url(); ?>Usercontroller/edit?id=<?php   echo $row->id; ?>" class="btn btn-primary">
                                <i class="fas fa-edit"></i>                 
                                </a>
                                <a href="<?php echo base_url(); ?>Usercontroller/delete?id=<?php   echo $row->id; ?>" class="btn btn-danger">
...
<script src="http://localhost/CRUD_CODE/assets/JS/table.js"></script>
